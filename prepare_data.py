...
def main():
    ...
    easy_data_path = OUT_DIR / "easy-data.json"
    with open(easy_data_path, "w", encoding="utf-8") as f:
        json.dump(easy_data, f, separators=(",", ":"))
    print(f"Wrote {easy_data_path} ({easy_data_path.stat().st_size / 1024:.0f} KB)", file=sys.stderr)
