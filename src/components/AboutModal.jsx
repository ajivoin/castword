    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal about-modal" onClick={e => e.stopPropagation()}>
        ...
        <section className="about-section">
          ...
          <p className="about-text">You have <strong>7 guesses</strong>. After each wrong guess, a new clue is revealed:</p>
          <ol className="about-steps">
            ...
            <li><span className="about-step-num">4</span> Flavor text — or, if the card has none, how many sets it's been printed in</li>
            <li><span className="about-step-num">5</span> First printed</li>
            <li><span className="about-step-num">6</span> Card text</li>
            <li><span className="about-step-num">7</span> Name shape — the answer with its letters and digits blanked out</li>
          </ol>
